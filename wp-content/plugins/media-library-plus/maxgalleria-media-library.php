...
class MaxGalleriaMediaLib {
  ...
  public function __construct() {
	...
	public function set_global_constants() {	
		...
		define('MAXGALLERIA_MEDIA_LIBRARY_VERSION_NUM', '3.2.7');
...
<!--          <div class="mgmlp-title" id='mg-prono-top'>
        ...
        <!--<p id='mlp-more-info'><a href='http://maxgalleria.com/media-library-plus/' target="_blank"><?php _e('Click here to learn about Media Library Plus', 'maxgalleria-media-library' ); ?></a></p>-->
    ...
    <div class="container">
      <div class="row">
        <div class="width-50">
          ...
          <a class="simple-btn block" href="https://maxgalleria.com/media-library-plus/">Click here to learn about the Media Library Plus</a>
        </div>
        <div class="width-50">
          <strong>
		...
		<img id="mlpp-logo" alt="Media Library Plus Pro Logo" src="<?php echo MAXGALLERIA_MEDIA_LIBRARY_PLUGIN_URL ?>/images/mlpp.png" width="235" height="235" >
  </div>
